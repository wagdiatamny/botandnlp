...
using SearsIL.ShopYourWay.Framework.Extensions;
...
namespace Platform.Client
{
	...
	public class PlatformProxy : IPlatformProxy
	{
		...
		public PlatformProxy(IWebClientBuilder webClientBuilder, IPlatformSettings platformSettings, IPlatformTokenProvider platformTokenProvider, IPlatformHashProvider platformHashProvider, IParametersTranslator parametersTranslator)
		{
		...
		{
			return MakeRequest<T>(GetServiceUrl(servicePath), parametersModel.GetParameters(), null, HttpMethod.Get);
		}
